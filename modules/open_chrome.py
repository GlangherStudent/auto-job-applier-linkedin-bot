'''
Chrome driver/session setup for LinkedIn bot.
...
def createChromeSession(isRetry: bool = False):
    make_directories([file_name,failed_file_name,f"{logs_folder_path}/screenshots",default_resume_path,f"{generated_resume_path}/temp"])
...
try:
    ...
    msg = 'Seems like Google Chrome is out dated. Update browser and try again! If issue persists, try Safe Mode (safe_mode = True in config/settings.py).'
